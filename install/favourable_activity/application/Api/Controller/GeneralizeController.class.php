...
//            '14.23.61.75',
	...
	private function checkOn($site_id, $thems){
		//站点-ID：3g-87, q-14,
		$urls[87]['wxgdtmb']	= 0;	//http://3g.chinaskin.cn/star/gdtmb 
		$urls[87]['wxfpmanqd']	= 0;	//http://3g.chinaskin.cn/star/manqd
		$urls[87]['mb_a']	= 1;	//http://3g.chinaskin.cn/direct/mb_a
		
		$urls[14]['wxfpgdtmb']	= 0;	//http://q.chinaskin.cn/star/gdtmb
		$urls[14]['wxfpmanqd']	= 0;	//http://q.chinaskin.cn/star/manqd
        $urls[14]['gdt_mb']		= 1;    //http://q.chinaskin.cn/star/gdt_mb
        $urls[14]['agentgdtmb']     = 0;    //http://q.chinaskin.cn/star/agentgdtmb
        ...
        $urls[14]['gdt_mb_wxtest']  =1; //q.chinaskin.cn/star/gdt_mb_wxtest
        $urls[14]['othermb']  =1; //q.chinaskin.cn/dr/othermb
        $urls[14]['agentmanqd']  =0; //q.chinaskin.cn/star/agentmanqd
        $urls[14]['drgdtmb']  =1; //q.chinaskin.cn/star/drgdtmb
        $urls[14]['lufeiqd_wx']  =1; //q.chinaskin.cn/star/lufeiqd_wx
        $urls[14]['bdmb']  = 1; //q.chinaskin.cn/star/bdmb
        $urls[14]['bdmb2']  = 1; //q.chinaskin.cn/star/bdmb2
